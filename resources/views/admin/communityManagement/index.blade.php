    ...
    <div class="grid grid-cols-3 gap-6 mt-6 xl:grid-cols-1">
        ...
        <div class="card col-span-3 xl:col-span-1">
            <div class="card-header flex justify-between items-center mb-4">
                <h2 class="text-lg font-semibold">Daftar Komunitas</h2>
                <a href="{{ route('communityManagement.create') }}"
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border px-4 py-2">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('communityManagement.edit', $user->id) }}"
                                        ...
                                        <form action="{{ route('communityManagement.destroy', $user->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
