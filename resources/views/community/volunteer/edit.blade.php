...
<div class="bg-gray-100 flex-1 p-6 md:mt-16">
  ...
  <div class="card max-w-4xl mx-auto">
    ...
    <form action="{{ route('communityVolunteer.update', $volunteer->id) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="col-span-2">
          ...
          <input type="text" id="registration_url" name="registration_url" 
                 class="mt-1 block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                 placeholder="Masukkan Link Registrasi" value="{{ old('registration_url', $volunteer->registration_url) }}">
