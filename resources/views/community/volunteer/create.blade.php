...
<div class="bg-gray-100 flex-1 p-6 md:mt-16">
  ...
  <div class="card max-w-4xl mx-auto">
    <div class="card-header flex justify-between items-center mb-4">
      <h2 class="text-lg font-semibold">Form Tambah Program Relawan</h2>
      <a href="{{ route('communityVolunteer.index') }}" 
    ...
    <form action="{{ route('communityVolunteer.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
      @csrf
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="col-span-2">
          ...
          <input type="text" id="contact_phone" name="contact_phone" 
                 class="mt-1 block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" 
                 placeholder="Masukkan nomor telepon" value="{{ old('contact_phone') }}">
          @error('contact_phone')
            <div class="text-red-500 text-sm">{{ $message }}</div>
          @enderror
        </div>
        ...
        <!-- Instagram -->
        <div class="col-span-2">
          <label for="contact_instagram" class="mx-3 block text-sm font-medium text-gray-700">Akun Instagram</label>
